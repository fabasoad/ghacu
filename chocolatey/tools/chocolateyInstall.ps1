...
$url = 'https://github.com/fabasoad/ghacu/releases/download/v1.1.0/ghacu.win-x86.exe' # download url
$url64 = 'https://github.com/fabasoad/ghacu/releases/download/v1.1.0/ghacu.win-x64.exe' # 64bit URL here or remove - if installer decides, then use $url
