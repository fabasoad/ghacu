...
OutputBaseFilename=ghacu-2.0.2-win-x86
Compression=lzma
...
[Files]
Source: "..\bin\ghacu-2.0.2-win-x86\ghacu.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\ghacu-2.0.2-win-x86\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
